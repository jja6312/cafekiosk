...
public class OrderService {
    ...
    public OrderResponse createOrder(OrderCreateRequest request, LocalDateTime registerDateTime) {
        ...
        List<Product> products = findProductsBy(productNumbers); // 주문 번호에 해당하는 상품들 가져오기

        deductStickQunatities(products, productNumbers);
    ...
    private void deductStickQunatities(List<Product> products, List<String> productNumbers) {
        ...
        for (String stockProductNumber : new HashSet<>(stockProductNumbers)) {
            ...
            stock.deductQuantity(quantity);  // 수량을 정확히 차감
        }
    }
